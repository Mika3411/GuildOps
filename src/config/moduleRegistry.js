...
export const guildOpsModules = Object.freeze([
  ...
  },
  {
    id: "wars_events",
    label: "Wars & Events",
    navLabel: "Wars & Events",
    mobileLabel: "Wars",
    description: "Planning, check-in et objectifs d'events.",
    benefit: "Préparer les wars, collecter les présences et donner un plan commun avant les gros rendez-vous.",
    route: "/app/wars",
    view: "wars",
